...
public class SmbWriteTypeTestCase extends CommonSmbConnectorTestCase {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][] {
        {"Smb - String", new org.mule.extension.smb.SmbTestHarness(), SMB_CONNECTION_XML, HELLO_WORLD, HELLO_WORLD},
        {"Smb - native byte", new org.mule.extension.smb.SmbTestHarness(), SMB_CONNECTION_XML, "A".getBytes()[0], "A"},
        {"Smb - Object byte", new org.mule.extension.smb.SmbTestHarness(), SMB_CONNECTION_XML, new Byte("A".getBytes()[0]),
            "A"},
        {"Smb - byte[]", new org.mule.extension.smb.SmbTestHarness(), SMB_CONNECTION_XML, HELLO_WORLD.getBytes(),
            HELLO_WORLD},
        {"Smb - OutputHandler", new org.mule.extension.smb.SmbTestHarness(), SMB_CONNECTION_XML, new TestOutputHandler(),
            HELLO_WORLD},
        {"Smb - InputStream", new org.mule.extension.smb.SmbTestHarness(), SMB_CONNECTION_XML,
