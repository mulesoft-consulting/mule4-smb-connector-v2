...
public class SmbDirectoryListener extends PollingSource<InputStream, SmbFileAttributes> {
  ...
  @Connection
  private ConnectionProvider<SmbFileSystem> fileSystemProvider;
  ...
  private SmbFileSystem openConnection(PollContext pollContext) throws Exception {

    SmbFileSystem fileSystem = fileSystemProvider.connect();
    try {
