...
public abstract class AbstractSmbCopyDelegate implements SmbCopyDelegate {
     ...
     * @param fileSystem the {@link SmbFileSystem} which connects to the remote server
     */
    public AbstractSmbCopyDelegate(SmbCommand command, SmbFileSystem fileSystem) {
    ...
    public void doCopy(FileConnectorConfig config, FileAttributes source, URI targetUri, boolean overwrite) {
        ConnectionHandler<SmbFileSystem> writerConnectionHandler;
        final SmbFileSystem writerConnection;
        try {
     ...
     * @param writerConnection the {@link SmbFileSystem} which connects to the target endpoint
     */
    ...
    private ConnectionHandler<SmbFileSystem> getWriterConnection(FileConnectorConfig config) throws ConnectionException {
