...
import static org.mule.extension.smb.internal.connection.SmbFileSystem.ROOT;
...
public abstract class SmbCommand extends ExternalFileCommand<SmbFileSystem> {
	...
	public SmbCommand(SmbFileSystem fileSystem) {
	 ...
	 *
	 * @param fileSystem a {@link SmbFileSystem} used as the connection object
	 * @param client a {@link SmbClient}
	 */
	public SmbCommand(SmbFileSystem fileSystem, SmbClient client) {
		super(fileSystem);
		this.client = client;
	}
