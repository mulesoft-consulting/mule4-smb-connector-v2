...
public class SmbFileRenameErrorTypeProvider implements ErrorTypeProvider {
    ...
    public Set<ErrorTypeDefinition> getErrorTypes() {
        return Collections.unmodifiableSet(new HashSet<SmbFileErrorType>(Arrays.asList(SmbFileErrorType.ILLEGAL_PATH, SmbFileErrorType.ACCESS_DENIED, SmbFileErrorType.FILE_ALREADY_EXISTS)));
    }
}