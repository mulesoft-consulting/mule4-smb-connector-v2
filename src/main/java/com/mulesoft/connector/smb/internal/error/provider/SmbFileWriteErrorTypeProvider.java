...
public class SmbFileWriteErrorTypeProvider implements ErrorTypeProvider {
    ...
    public Set<ErrorTypeDefinition> getErrorTypes() {
        return Collections.unmodifiableSet(new HashSet<SmbFileErrorType>(Arrays.asList(SmbFileErrorType.ILLEGAL_PATH, SmbFileErrorType.ILLEGAL_CONTENT, SmbFileErrorType.FILE_ALREADY_EXISTS, SmbFileErrorType.ACCESS_DENIED, SmbFileErrorType.FILE_LOCK)));
    }
